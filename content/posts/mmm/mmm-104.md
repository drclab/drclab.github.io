...
Equivalently, GRP is the sum of **rating points** across all spots in the plan. For example, if a campaign reaches 40% of the target audience at an average frequency of 3, then $\text{GRP} = 40 \times 3 = 120$. This matters for MMM because GRP is a common exposure input, and its construction clarifies what variation is being modeled (reach vs frequency vs total delivery).
