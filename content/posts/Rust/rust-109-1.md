...
date = "2026-07-28"
tags = ["rust", "panic", "unwinding", "backtrace"]
categories = ["posts"]
series = ["Rust 109"]
type = "post"
draft = false
...
Welcome to Rust 109-1! In Rust, some errors are unrecoverable—situations where your program can't continue safely. The `panic!` macro stops execution immediately. In this post, we'll explore panics, how Rust handles them, and when to use them.
