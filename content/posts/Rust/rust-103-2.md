...
date = "2026-01-05"
tags = ["rust", "data-types", "scalar", "compound", "integer", "tuple", "array", "programming"]
categories = ["posts"]
series = ["Rust 101"]
type = "post"
draft = false
...
**Tip**: Use `f64` by default—it has more precision and is roughly the same speed as `f32` on modern CPUs.
...
This is an example of Rust's **memory safety** principles—the program exits rather than accessing invalid memory.
